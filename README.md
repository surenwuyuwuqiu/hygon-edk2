...
​      当8/16位深度时，单个原始颜色 （R/G/B）最大只能表示为[2^3 ,2^6]， 无法满足[0,0xff]的范围，所以显示的颜色范围有限。
...
在本地创建Ubuntu虚拟机，在Linux环境下安装编译环境：[github.com/tianocore/tianocore.github.io/wiki/Common-instructions](https://github.com/tianocore/tianocore.github.io/wiki/Common-instructions)
